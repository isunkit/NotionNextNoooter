  ...
  return (
    <div
      ...
      <div
        ...
        } max-h-[80vh] flex flex-col justify-between w-full min-h-[10rem] h-full md:h-fit max-w-xl dark:bg-hexo-black-gray dark:border-gray-800 bg-white dark:bg- p-5 rounded-lg z-50 shadow border hover:border-indigo-600 duration-300 transition-all `}>
        <div className='flex justify-between items-center'>
          <div className='text-2xl text-indigo-600 dark:text-yellow-600 font-bold'>
            搜索
          </div>
          <div>
            <i
              className='text-gray-600 fa-solid fa-xmark p-1 cursor-pointer hover:text-indigo-600'
        ...
        <input
          ...
          className='text-black dark:text-gray-200 bg-gray-50 dark:bg-gray-600 outline-indigo-500 w-full px-4 my-2 py-1 mb-4 border rounded-md'
          ref={inputRef}
        />
